    ...
    <>
      <div className="content-container main-container">
        <div className="bestill-container">
          ...
          {tabellLinckBlad && tabellLinckBlad[16].typeCount < 15 && (
            <p className="bestill-tools">
        ...
        {`
          ...
          .main-container {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
              url("https://images.unsplash.com/photo-1579546929662-711aa81148cf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y29sb3JmdWwlMjBiYWNrZ3JvdW5kfGVufDB8fDB8fA%3D%3D&w=1000&q=80");
            display: grid;
            place-items: center;
