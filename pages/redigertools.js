    ...
    (async () => {
      try {
        const response = await api.get(
          `/api/tool/getToolWasteByDate?yearRequest=${yearRequest}&&month=${month}&&day=${day}&&yearRequest2=${yearRequest2}&&month2=${month2}&&day2=${day2}`
        );
    ...
    <>
      <PageLayoutSidebar>
        ...
        <RedigerToolsMain
          ...
          toolUpdateDatabase={toolUpdateDatabase}
          setToolUpdateDatabase={setToolUpdateDatabase}
        />
      </PageLayoutSidebar>
      <style jsx>
        {`
